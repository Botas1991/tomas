<%@ Page Title="Post" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Content.aspx.cs" Inherits="Content" %>
    ...
    <table class="Content_CRUD">
        <tr>
            ...
            <td>
              ...
              <br />
              <asp:ListBox ID="ListBox1" runat="server" Height="166px" Width="288px"></asp:ListBox>
              <br />
            </td><%-- Konec radku --%>
        </tr>
        <tr>
